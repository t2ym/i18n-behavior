...
});});}(params.setup?teardown:suiteTeardown)(function(){restoreFixture(params.fixture);});});});};const bundledImportMeta$6={...import.meta,url:new URL('./preference/preference-element.js',import.meta.url).href};const $_documentContainer$2=document.createElement('template');$_documentContainer$2.innerHTML=`<template id="preference-element">
    <span id="oldLang"></span>
  </template>`;document.head.appendChild($_documentContainer$2.content);switch(syntax){default:case'mixin':{class PreferenceElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$6;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="oldLang"></span>
<template id="localizable-text">
<json-data>
{
