...
});});}(params.setup?teardown:suiteTeardown)(function(){restoreFixture(params.fixture);});});});};const bundledImportMeta$6={...import.meta,url:new URL('./edge-case/empty-element.js',import.meta.url).href};const $_documentContainer$2=document.createElement('template');$_documentContainer$2.innerHTML=`<template id="empty-element">
  </template>`;document.head.appendChild($_documentContainer$2.content);switch(syntax){default:case'mixin':{class EmptyElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$6;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
...
`);}static get is(){return'empty-element';}}customElements.define(EmptyElement.is,EmptyElement);}break;case'base-element':{class EmptyElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$6;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
...
`);}static get is(){return'empty-element';}}customElements.define(EmptyElement.is,EmptyElement);}break;case'thin':{Define=class EmptyElement extends BaseElements.I18nElement{};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$6,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
...
`),is:'empty-element',behaviors:[BehaviorsStore.I18nBehavior]});}break;}const bundledImportMeta$7={...import.meta,url:new URL('./edge-case/no-template-element.js',import.meta.url).href};switch(syntax){default:case'mixin':{class NoTemplateElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$7;}static get is(){return'no-template-element';}}customElements.define(NoTemplateElement.is,NoTemplateElement);}break;case'base-element':{class NoTemplateElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$7;}static get is(){return'no-template-element';}}customElements.define(NoTemplateElement.is,NoTemplateElement);}break;case'thin':{Define=class NoTemplateElement extends BaseElements.I18nElement{};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$7,is:'no-template-element',behaviors:[BehaviorsStore.I18nBehavior]});}break;}const bundledImportMeta$8={...import.meta,url:new URL('./edge-case/complex-compound-binding-element.js',import.meta.url).href};const $_documentContainer$3=document.createElement('template');$_documentContainer$3.innerHTML=`<template id="complex-compound-binding-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$3.content);switch(syntax){default:case'mixin':{class ComplexCompoundBindingElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$8;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
...
`),is:'complex-compound-binding-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},_langUpdated:function(e){console.log('complex-compound-binding-element: lang-updated lang = '+this.lang+' effectiveLang = '+this.effectiveLang);window.setTimeout(function(){Array.prototype.forEach.call(this.root.querySelectorAll('i18n-format'),function(node){if(!node.elements){console.log('elements are missing',node);node.ready();}node.render();});console.log(this.is+' local-dom-ready ');this.fire('local-dom-ready');}.bind(this),1);}});}break;}const bundledImportMeta$9={...import.meta,url:new URL('./edge-case/advanced-binding-element.js',import.meta.url).href};const $_documentContainer$4=document.createElement('template');$_documentContainer$4.innerHTML=`<template id="advanced-binding-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$4.content);switch(syntax){default:case'mixin':{class AdvancedBindingElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$9;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="status">{{tr(status,text.statusMessages)}}</span>
...
`);}static get is(){return'advanced-binding-element';}static get config(){return{properties:{status:{type:String,value:'ok'},value:{type:String},parameter:{type:String}},listeners:{'lang-updated':'_langUpdated','rendered':'_rendered'}};}connectedCallback(){//console.log('advanced-binding-element: connected');
...
super.connectedCallback();}disconnectedCallback(){super.disconnectedCallback();//console.log('advanced-binding-element: disconnected');
                                           ...
                                           this.effectiveLang === this.lang*/){this.model=deepcopy(this.text.model);this._checkLang();}}_rendered(e){console.log('rendered',e.composedPath()[0],e.target,e.detail,'lang = '+this.lang,'effectiveLang = '+this.effectiveLang,'e.target.lang = '+e.target.lang);this._checkLang();}_checkLang(){var i18nFormats=this.root.querySelectorAll('i18n-format');var allLangUpdated=this.lang===this.effectiveLang;Array.prototype.forEach.call(i18nFormats,function(el){if(el.lang!==this.lang){allLangUpdated=false;}else{el.render();}}.bind(this));if(allLangUpdated){this.fire('local-dom-ready');}}}customElements.define(AdvancedBindingElement.is,AdvancedBindingElement);}break;case'thin':{Define=class AdvancedBindingElement extends BaseElements.I18nElement{static get config(){return{properties:{status:{type:String,value:'ok'},value:{type:String},parameter:{type:String}},listeners:{'lang-updated':'_langUpdated','rendered':'_rendered'}};}connectedCallback(){//console.log('advanced-binding-element: connected');
super.connectedCallback();}disconnectedCallback(){super.disconnectedCallback();//console.log('advanced-binding-element: disconnected');
}_langUpdated(e){console.log('lang-updated',e.composedPath()[0],e.target,e.detail,'lang = '+this.lang,'effectiveLang = '+this.effectiveLang);if(e.composedPath()[0]===this/*&&
                                           this.effectiveLang === this.lang*/){this.model=deepcopy(this.text.model);this._checkLang();}}_rendered(e){console.log('rendered',e.composedPath()[0],e.target,e.detail,'lang = '+this.lang,'effectiveLang = '+this.effectiveLang,'e.target.lang = '+e.target.lang);this._checkLang();}_checkLang(){var i18nFormats=this.root.querySelectorAll('i18n-format');var allLangUpdated=this.lang===this.effectiveLang;Array.prototype.forEach.call(i18nFormats,function(el){if(el.lang!==this.lang){allLangUpdated=false;}else{el.render();}}.bind(this));if(allLangUpdated){this.fire('local-dom-ready');}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$9,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="status">{{tr(status,text.statusMessages)}}</span>
