...
var Polymer$2=function(proto){BehaviorsStore._I18nAttrRepo=proto;BehaviorsStore._I18nAttrRepo._created();return Polymer$1(proto);};/*
   ...
   */Polymer$2({importMeta:bundledImportMeta$2,is:'i18n-attr-repo',created:function(){this.data=sharedData;var customAttributes=dom(this).querySelector('template#custom');// traverse custom attributes repository
...
var template=$_documentContainer$2.content.querySelector('template#i18n-preference');var domModule=document.createElement('dom-module');//var currentScript = (!window.HTMLImports || HTMLImports.hasNative || HTMLImports.useNative) ? document.currentScript : (document._currentScript || document.currentScript);
...
if(!this._htmlLangMutationObserver){this._htmlLangMutationObserverCallbackBindThis=this._htmlLangMutationObserverCallback.bind(this);this._htmlLangMutationObserver=new MutationObserver(this._htmlLangMutationObserverCallbackBindThis);}this._htmlLangMutationObserver.observe(html,{attributes:true});},/**
       ...
       */_disconnect:function(){if(this._htmlLangMutationObserver){this._htmlLangMutationObserver.disconnect();}}});};if(!window.HTMLImports||HTMLImports.hasNative||HTMLImports.useNative){registerI18nPreference();}else{HTMLImports.whenReady(registerI18nPreference);}})(document);/*!
...
ref=reference[index];}clone[key]=ref||recursiveCopy(value,customizer,result,visited,reference);}return clone;}exports['default']=deepcopy;module.exports=exports['default'];/***/}]/******/));}();var deepcopy$2={default:deepcopy$1};//$_documentContainer.innerHTML = `<i18n-attr-repo></i18n-attr-repo>`;
...
addEventListener('load',function(event){document.querySelector('body').appendChild(userPreference);});}// debug log when <html debug> attribute exists
...
if(this.is==='i18n-dom-bind'){this._propertyEffects=deepcopy$1(this._propertyEffects);}else{var template=DomModule.import(this.is,'template');if(template&&template.hasAttribute('lang')){this.templateDefaultLang=template.getAttribute('lang')||'';}if(!this._fetchStatus){this._fetchStatus=deepcopy$1({// per custom element
...
this.observer=new MutationObserver(this._handleLangAttributeChange.bind(this));this.observer.observe(this,{attributes:true,attributeFilter:['lang'],attributeOldValue:true});}},/**
     ...
     */ready:function(){if(this.is==='i18n-dom-bind'){if(!this._templateLocalizable){this._templateLocalizable=this._constructDefaultBundle();}if(!this._fetchStatus){this._fetchStatus=deepcopy$1({// per instance
...
for(var p in this._propertyEffects){if(this._propertyEffects[p]&&!Object.getOwnPropertyDescriptor(this,p)){Polymer.Bind._createAccessors(this,p,this._propertyEffects[p]);}}this.removeEventListener('dom-change',this._onDomChangeBindThis);if(this.text&&this.text.model){this.model=deepcopy$1(this.text.model);}// Fix #17: [Polymer 1.3.0] observeHtmlLang is undefined in i18n-dom-bind
...
`),is:'simple-text-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
  ...
  </template>`;document.head.appendChild($_documentContainer$4.content);switch(syntax){default:case'mixin':{class CommentedSimpleTextElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$7;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
...
`),is:'commented-simple-text-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(e){console.log(this.is,'lang-updated',e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model);}}});}break;}const bundledImportMeta$8={...import.meta,url:new URL('./plural-gender-element/plural-gender-element.js',import.meta.url).href};const $_documentContainer$5=document.createElement('template');$_documentContainer$5.innerHTML=`<template id="plural-gender-element">
    <p>
  ...
  </template>`;document.head.appendChild($_documentContainer$5.content);switch(syntax){default:case'mixin':{class PluralGenderElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$8;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <p>
...
<template id="text-attribute-element">
  ...
  <span>text</span>
</template>`;document.head.appendChild($_documentContainer$6.content);switch(syntax){default:case'mixin':{class TextAttributeElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$9;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="attr1">{{customTextAttr1}}</span>
    <span id="attr2">{{customTextAttr2}}</span>
    <span id="attr3">{{customTextAttr3}}</span>
    <span id="attr4">{{outOfScopeAttr}}</span>
...
`),is:'text-attribute-element',behaviors:[BehaviorsStore.I18nBehavior],properties:{customTextAttr1:{type:String,reflectToAttribute:true},customTextAttr2:{type:String,reflectToAttribute:true},customTextAttr3:{type:String,reflectToAttribute:true},outOfScopeAttr:{type:String,reflectToAttribute:true},i18nTarget:{type:String},i18nTarget2:{type:String}},listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(){this.model=deepcopy(this.text.model);}});}break;}const bundledImportMeta$a={...import.meta,url:new URL('./simple-attribute-element/simple-attribute-element.js',import.meta.url).href};const $_documentContainer$7=document.createElement('template');$_documentContainer$7.innerHTML=`<template id="simple-attribute-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$7.content);switch(syntax){default:case'mixin':{class SimpleAttributeElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$a;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`),is:'simple-attribute-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated','pie-chart.google-chart-render':'_pieChartRendered','column-chart.google-chart-render':'_columnChartRendered'},ready:function(){//this.observeHtmlLang = false;
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
  </template>`;document.head.appendChild($_documentContainer$8.content);switch(syntax){default:case'mixin':{class FallbackTextElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$b;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`),is:'fallback-text-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
  ...
  </template>`;document.head.appendChild($_documentContainer$9.content);switch(syntax){default:case'mixin':{class CompoundBindingElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$c;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`<i18n-format lang="{{effectiveLang}}"><span>{{text.text.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format><div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
...
},attached:function(){},_langUpdated:function(e){console.log(this.is,'lang-updated',e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model);}}});}break;}const bundledImportMeta$d={...import.meta,url:new URL('./simple-text-id-element/simple-text-id-element.js',import.meta.url).href};const $_documentContainer$a=document.createElement('template');$_documentContainer$a.innerHTML=`<template id="simple-text-id-element">
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
