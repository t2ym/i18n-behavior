...
this._observeHtmlLangChanged(true);}},/**
   ...
   */_onDomChange:function(){/* Drop fix for Polymer 1.x
    ...
    */this.removeEventListener('dom-change',this._onDomChangeBindThis);if(this.text&&this.text.model){this.model=deepcopy$1(this.text.model);}/* Drop fix for Polymer 1.x
