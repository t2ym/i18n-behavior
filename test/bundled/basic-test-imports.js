...
if(!this._htmlLangMutationObserver){this._htmlLangMutationObserverCallbackBindThis=this._htmlLangMutationObserverCallback.bind(this);this._htmlLangMutationObserver=new MutationObserver(this._htmlLangMutationObserverCallbackBindThis);}this._htmlLangMutationObserver.observe(html$1,{attributes:true});},/**
   ...
   */_disconnect:function(){if(this._htmlLangMutationObserver){this._htmlLangMutationObserver.disconnect();}}});/*!
     ...
     */var deepcopy$1=function(){return(/******/function(modules){// webpackBootstrap
/******/ // The module cache
...
ref=reference[index];}clone[key]=ref||recursiveCopy(value,customizer,result,visited,reference);}return clone;}exports['default']=deepcopy;module.exports=exports['default'];/***/}]/******/));}();var deepcopy$2={default:deepcopy$1};var html$2=document.querySelector('html');// app global bundle storage
...
if(this.text){this.model=deepcopy$1(this.text.model);}}},/**
...
assert.equal(getProperty(nodes[0],p),translate(params.effectiveLang,p,childPath[p]),p+' is set as '+translate(params.effectiveLang,p,childPath[p]));}}//console.log(childPath);
});});}(params.setup?teardown:suiteTeardown)(function(){restoreFixture(params.fixture);});});});};const bundledImportMeta$6={...import.meta,url:new URL('./simple-text-element/simple-text-element.js',import.meta.url).href};const $_documentContainer$2=document.createElement('template');$_documentContainer$2.innerHTML=`<template id="simple-text-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$2.content);switch(syntax){default:case'mixin':{class SimpleTextElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$6;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
...
`),is:'simple-text-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
  ...
  </template>`;document.head.appendChild($_documentContainer$3.content);switch(syntax){default:case'mixin':{class CommentedSimpleTextElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$7;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
...
`);}static get is(){return'commented-simple-text-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}ready(){super.ready();}_langUpdated(e){console.log(this.is,'lang-updated',e.detail);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}}customElements.define(CommentedSimpleTextElement.is,CommentedSimpleTextElement);}break;case'thin':{Define=class CommentedSimpleTextElement extends BaseElements.I18nElement{static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}ready(){super.ready();}_langUpdated(e){console.log(this.is,'lang-updated',e.detail);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$7,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
<!-- comment -->{{text.text}}<!-- comment -->
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; <!-- comment --></span><!-- comment -->
    <h1>{{text.h1_3}}<!-- comment --></h1><!-- comment -->{{text.text_4}}<!-- comment -->
...
`),is:'commented-simple-text-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(e){console.log(this.is,'lang-updated',e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model);}}});}break;}const bundledImportMeta$8={...import.meta,url:new URL('./plural-gender-element/plural-gender-element.js',import.meta.url).href};const $_documentContainer$4=document.createElement('template');$_documentContainer$4.innerHTML=`<template id="plural-gender-element">
    <p>
  ...
  </template>`;document.head.appendChild($_documentContainer$4.content);switch(syntax){default:case'mixin':{class PluralGenderElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$8;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <p>
...
`);}static get is(){return'plural-gender-element';}static get config(){return{properties:{sender:{type:Object},recipients:{type:Array}},listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){console.log('plural-gender-element lang-updated lang = '+this.lang+' effectiveLang = '+this.effectiveLang);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}if(this.renderedEffectiveLang===this.effectiveLang||this.renderedEffectiveLang===''&&this.effectiveLang==='en'){this.fire('local-dom-ready');}}_rendered(){console.log('plural-gender-element rendered lang = '+this.lang+' effectiveLang = '+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire('local-dom-ready');}else{this.renderedEffectiveLang=this.effectiveLang;}}}customElements.define(PluralGenderElement.is,PluralGenderElement);}break;case'base-element':{class PluralGenderElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$8;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <p>
      <i18n-format id="compound-format-text" on-rendered="_rendered" lang="{{effectiveLang}}">
        <json-data>{{serialize(text.compound-format-text.0)}}</json-data>
        <i18n-number offset="1" slot="1" lang="{{effectiveLang}}">{{recipients.length}}</i18n-number>
...
`);}static get is(){return'plural-gender-element';}static get config(){return{properties:{sender:{type:Object},recipients:{type:Array}},listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){console.log('plural-gender-element lang-updated lang = '+this.lang+' effectiveLang = '+this.effectiveLang);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}if(this.renderedEffectiveLang===this.effectiveLang||this.renderedEffectiveLang===''&&this.effectiveLang==='en'){this.fire('local-dom-ready');}}_rendered(){console.log('plural-gender-element rendered lang = '+this.lang+' effectiveLang = '+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire('local-dom-ready');}else{this.renderedEffectiveLang=this.effectiveLang;}}}customElements.define(PluralGenderElement.is,PluralGenderElement);}break;case'thin':{Define=class PluralGenderElement extends BaseElements.I18nElement{static get config(){return{properties:{sender:{type:Object},recipients:{type:Array}},listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){console.log('plural-gender-element lang-updated lang = '+this.lang+' effectiveLang = '+this.effectiveLang);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}if(this.renderedEffectiveLang===this.effectiveLang||this.renderedEffectiveLang===''&&this.effectiveLang==='en'){this.fire('local-dom-ready');}}_rendered(){console.log('plural-gender-element rendered lang = '+this.lang+' effectiveLang = '+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire('local-dom-ready');}else{this.renderedEffectiveLang=this.effectiveLang;}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$8,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <p>
      <i18n-format id="compound-format-text" on-rendered="_rendered" lang="{{effectiveLang}}">
        <json-data>{{serialize(text.compound-format-text.0)}}</json-data>
        <i18n-number offset="1" slot="1" lang="{{effectiveLang}}">{{recipients.length}}</i18n-number>
...
<template id="text-attribute-element">
  ...
  <span>text</span>
</template>`;document.head.appendChild($_documentContainer$5.content);switch(syntax){default:case'mixin':{class TextAttributeElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$9;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="attr1">{{customTextAttr1}}</span>
    <span id="attr2">{{customTextAttr2}}</span>
    <span id="attr3">{{customTextAttr3}}</span>
    <span id="attr4">{{outOfScopeAttr}}</span>
...
`);}static get is(){return'text-attribute-element';}static get config(){return{properties:{customTextAttr1:{type:String,reflectToAttribute:true},customTextAttr2:{type:String,reflectToAttribute:true},customTextAttr3:{type:String,reflectToAttribute:true},outOfScopeAttr:{type:String,reflectToAttribute:true},i18nTarget:{type:String},i18nTarget2:{type:String}},listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(){this.model=deepcopy(this.text.model);}}customElements.define(TextAttributeElement.is,TextAttributeElement);}break;case'base-element':{class TextAttributeElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$9;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="attr1">{{customTextAttr1}}</span>
    <span id="attr2">{{customTextAttr2}}</span>
    <span id="attr3">{{customTextAttr3}}</span>
    <span id="attr4">{{outOfScopeAttr}}</span>
...
`);}static get is(){return'text-attribute-element';}static get config(){return{properties:{customTextAttr1:{type:String,reflectToAttribute:true},customTextAttr2:{type:String,reflectToAttribute:true},customTextAttr3:{type:String,reflectToAttribute:true},outOfScopeAttr:{type:String,reflectToAttribute:true},i18nTarget:{type:String},i18nTarget2:{type:String}},listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(){this.model=deepcopy(this.text.model);}}customElements.define(TextAttributeElement.is,TextAttributeElement);}break;case'thin':{Define=class TextAttributeElement extends BaseElements.I18nElement{static get config(){return{properties:{customTextAttr1:{type:String,reflectToAttribute:true},customTextAttr2:{type:String,reflectToAttribute:true},customTextAttr3:{type:String,reflectToAttribute:true},outOfScopeAttr:{type:String,reflectToAttribute:true},i18nTarget:{type:String},i18nTarget2:{type:String}},listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(){this.model=deepcopy(this.text.model);}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$9,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="attr1">{{customTextAttr1}}</span>
    <span id="attr2">{{customTextAttr2}}</span>
    <span id="attr3">{{customTextAttr3}}</span>
    <span id="attr4">{{outOfScopeAttr}}</span>
...
`),is:'text-attribute-element',behaviors:[BehaviorsStore.I18nBehavior],properties:{customTextAttr1:{type:String,reflectToAttribute:true},customTextAttr2:{type:String,reflectToAttribute:true},customTextAttr3:{type:String,reflectToAttribute:true},outOfScopeAttr:{type:String,reflectToAttribute:true},i18nTarget:{type:String},i18nTarget2:{type:String}},listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(){this.model=deepcopy(this.text.model);}});}break;}const bundledImportMeta$a={...import.meta,url:new URL('./simple-attribute-element/simple-attribute-element.js',import.meta.url).href};const $_documentContainer$6=document.createElement('template');$_documentContainer$6.innerHTML=`<template id="simple-attribute-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$6.content);switch(syntax){default:case'mixin':{class SimpleAttributeElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$a;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`);}static get is(){return'simple-attribute-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'//'pie-chart.google-chart-render': '_pieChartRendered',
//'column-chart.google-chart-render': '_columnChartRendered'
}};}connectedCallback(){super.connectedCallback();this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1000);setTimeout(function(){this.isPieChartRendered=true;this.isColumnChartRendered=true;window.clearInterval(this._intervalId);this.fire('local-dom-ready');// TODO: this is an ad-hoc solution
...
}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}_langUpdated(e){if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}_pieChartRendered(){this.isPieChartRendered=true;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}_columnChartRendered(){this.isColumnChartRendered=true;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}}customElements.define(SimpleAttributeElement.is,SimpleAttributeElement);}break;case'base-element':{class SimpleAttributeElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$a;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}_langUpdated(e){if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}_pieChartRendered(){this.isPieChartRendered=true;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}_columnChartRendered(){this.isColumnChartRendered=true;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}}customElements.define(SimpleAttributeElement.is,SimpleAttributeElement);}break;case'thin':{Define=class SimpleAttributeElement extends BaseElements.I18nElement{static get config(){return{listeners:{'lang-updated':'_langUpdated'//'pie-chart.google-chart-render': '_pieChartRendered',
//'column-chart.google-chart-render': '_columnChartRendered'
}};}connectedCallback(){super.connectedCallback();this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1000);setTimeout(function(){this.isPieChartRendered=true;this.isColumnChartRendered=true;window.clearInterval(this._intervalId);this.fire('local-dom-ready');// TODO: this is an ad-hoc solution
}.bind(this),200);}disconnectedCallback(){super.disconnectedCallback();}_checkChartStatus(){var pieChartInnerHtml=this.$['pie-chart'].$.chartdiv.innerHTML;var columnChartInnerHtml=this.$['column-chart'].$.chartdiv.innerHTML;var notLoaded=false;if(pieChartInnerHtml==='Undefined chart type'){this.isPieChartRendered=true;// google api to blame; this is not responsible
}if(columnChartInnerHtml==='Undefined chart type'){this.isColumnChartRendered=true;// google api to blame; this is not responsible
}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}_langUpdated(e){if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}_pieChartRendered(){this.isPieChartRendered=true;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}_columnChartRendered(){this.isColumnChartRendered=true;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire('local-dom-ready');}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$a,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`),is:'simple-attribute-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated','pie-chart.google-chart-render':'_pieChartRendered','column-chart.google-chart-render':'_columnChartRendered'},ready:function(){//this.observeHtmlLang = false;
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
  </template>`;document.head.appendChild($_documentContainer$7.content);switch(syntax){default:case'mixin':{class FallbackTextElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$b;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`);}static get is(){return'fallback-text-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){console.log(this.is,'lang-updated',e.detail);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}}customElements.define(FallbackTextElement.is,FallbackTextElement);}break;case'thin':{Define=class FallbackTextElement extends BaseElements.I18nElement{static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){console.log(this.is,'lang-updated',e.detail);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$b,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`),is:'fallback-text-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(e){console.log(this.is,'lang-updated',e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model);}}});}break;}const bundledImportMeta$c={...import.meta,url:new URL('./compound-binding-element/compound-binding-element.js',import.meta.url).href};const $_documentContainer$8=document.createElement('template');$_documentContainer$8.innerHTML=`<template id="compound-binding-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$8.content);switch(syntax){default:case'mixin':{class CompoundBindingElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$c;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`<i18n-format lang="{{effectiveLang}}"><span>{{text.text.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format><div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
...
`);}static get is(){return'compound-binding-element';}static get config(){return{properties:{param1:{type:String,value:'parameter 1'},param2:{type:String,value:'parameter 2'}},listeners:{'lang-updated':'_langUpdated'}};}ready(){super.ready();}_langUpdated(e){console.log(this.is,'lang-updated',e.detail);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}}customElements.define(CompoundBindingElement.is,CompoundBindingElement);}break;case'thin':{Define=class CompoundBindingElement extends BaseElements.I18nElement{static get config(){return{properties:{param1:{type:String,value:'parameter 1'},param2:{type:String,value:'parameter 2'}},listeners:{'lang-updated':'_langUpdated'}};}ready(){super.ready();}_langUpdated(e){console.log(this.is,'lang-updated',e.detail);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model);}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$c,_template:(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`<i18n-format lang="{{effectiveLang}}"><span>{{text.text.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format><div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1><i18n-format lang="{{effectiveLang}}"><span>{{text.h1_3.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format></h1><i18n-format lang="{{effectiveLang}}"><span>{{text.text_4.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format><span><i18n-format lang="{{effectiveLang}}"><span>{{text.span_5.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format></span>
    <span><i18n-format lang="{{effectiveLang}}"><span>{{text.span_6.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format></span>
    <span id="label-1"><i18n-format lang="{{effectiveLang}}"><span>{{text.label-1.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format></span>
...
`),is:'compound-binding-element',behaviors:[BehaviorsStore.I18nBehavior],properties:{param1:{type:String,value:'parameter 1'},param2:{type:String,value:'parameter 2'}},listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(e){console.log(this.is,'lang-updated',e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model);}}});}break;}const bundledImportMeta$d={...import.meta,url:new URL('./simple-text-id-element/simple-text-id-element.js',import.meta.url).href};const $_documentContainer$9=document.createElement('template');$_documentContainer$9.innerHTML=`<template id="simple-text-id-element">
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    ...
    outermost text at the end 
  </template>`;document.head.appendChild($_documentContainer$9.content);switch(syntax){default:case'mixin':{class SimpleTextIdElement extends Mixins.Localizable(Polymer.LegacyElement){static get importMeta(){return bundledImportMeta$d;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span text-id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
