...
assert.equal(getProperty(nodes[0],p),translate(params.effectiveLang,p,childPath[p]),p+' is set as '+translate(params.effectiveLang,p,childPath[p]));}}//console.log(childPath);
});});}(params.setup?teardown:suiteTeardown)(function(){restoreFixture(params.fixture);});});});};const bundledImportMeta$6={...import.meta,url:new URL('./template-default-lang/template-default-lang-element.js',import.meta.url).href};const $_documentContainer$2=document.createElement('template');$_documentContainer$2.innerHTML=`<template id="template-default-lang-element" lang="fr">
  ...
  </template>`;document.head.appendChild($_documentContainer$2.content);switch(syntax){default:case'mixin':{class TemplateDefaultLangElement extends Mixins.Logger(Mixins.Localizable(Polymer.LegacyElement)){static get importMeta(){return bundledImportMeta$6;}static get template(){return(t=>{t.setAttribute("lang","fr");return t;})((t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
...
`));}static get is(){return'template-default-lang-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){if(e.composedPath()[0]===this&&this.text){this.model=deepcopy(this.text.model);}}}customElements.define(TemplateDefaultLangElement.is,TemplateDefaultLangElement);}break;case'base-element':{class TemplateDefaultLangElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$6;}static get template(){return(t=>{t.setAttribute("lang","fr");return t;})((t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`));}static get is(){return'template-default-lang-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){if(e.composedPath()[0]===this&&this.text){this.model=deepcopy(this.text.model);}}}customElements.define(TemplateDefaultLangElement.is,TemplateDefaultLangElement);}break;case'thin':{Define=class TemplateDefaultLangElement extends BaseElements.I18nElement{static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){if(e.composedPath()[0]===this&&this.text){this.model=deepcopy(this.text.model);}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$6,_template:(t=>{t.setAttribute("lang","fr");return t;})((t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`)),is:'template-default-lang-element',behaviors:[BehaviorsStore.I18nBehavior],listeners:{'lang-updated':'_langUpdated'},ready:function(){//this.observeHtmlLang = false;
},attached:function(){},_langUpdated:function(e){if(dom(e).rootTarget===this&&this.text){this.model=deepcopy(this.text.model);}}});}break;}const bundledImportMeta$7={...import.meta,url:new URL('./template-default-lang/null-template-default-lang-element.js',import.meta.url).href};const $_documentContainer$3=document.createElement('template');$_documentContainer$3.innerHTML=`<template id="null-template-default-lang-element" lang="">
  ...
  </template>`;document.head.appendChild($_documentContainer$3.content);switch(syntax){default:case'mixin':{class NullTemplateDefaultLangElement extends Mixins.Logger(Mixins.Localizable(Polymer.LegacyElement)){static get importMeta(){return bundledImportMeta$7;}static get template(){return(t=>{t.setAttribute("lang","");return t;})((t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`));}static get is(){return'null-template-default-lang-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){if(e.composedPath()[0]===this&&this.text){this.model=deepcopy(this.text.model);}}}customElements.define(NullTemplateDefaultLangElement.is,NullTemplateDefaultLangElement);}break;case'base-element':{class NullTemplateDefaultLangElement extends BaseElements.I18nElement{static get importMeta(){return bundledImportMeta$7;}static get template(){return(t=>{t.setAttribute("lang","");return t;})((t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`));}static get is(){return'null-template-default-lang-element';}static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){if(e.composedPath()[0]===this&&this.text){this.model=deepcopy(this.text.model);}}}customElements.define(NullTemplateDefaultLangElement.is,NullTemplateDefaultLangElement);}break;case'thin':{Define=class NullTemplateDefaultLangElement extends BaseElements.I18nElement{static get config(){return{listeners:{'lang-updated':'_langUpdated'}};}_langUpdated(e){if(e.composedPath()[0]===this&&this.text){this.model=deepcopy(this.text.model);}}};}break;case'legacy':{Polymer$1({importMeta:bundledImportMeta$7,_template:(t=>{t.setAttribute("lang","");return t;})((t=>{t.setAttribute("localizable-text","embedded");return t;})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
