...
import deepcopy from "../../node_modules/deepcopy/dist/deepcopy.js";
...
Polymer({
  ...
  _template: (t => {
    t.setAttribute("localizable-text", "embedded");
    return t;
  })(html`
    <style>
    .text {
...
`),
  ...
  observers: ['_update(effectiveLang,recipientsLength,recipientsIndex,model.data.recipients)'],
  listeners: {
  ...
  _updateParameters: function () {
    if (this.model && this.model.data && this.model.data.recipients) {
