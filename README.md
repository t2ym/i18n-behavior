...
- [PoC Demo with Polyfill/Vulcanize/Babel](https://t2ym.github.io/i18n-element/components/i18n-element/demo/pocbabelvulcanized/index.html)
...
- Element class is registered globally as `window.ElementClass`
