  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      function copyValue(target) {
        var targetType = typeof target; // copy String, Number, Boolean, undefined and Symbol
    ...
    function (module, exports, __webpack_require__) {
      ...
      function deepcopy(target) {
        var customizer = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : defaultCustomizer;
        ...
        var visited = [target],
            reference = [clone]; // recursively copy from collection
