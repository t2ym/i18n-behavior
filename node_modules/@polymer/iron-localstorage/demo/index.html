...
<body>
  <div class="vertical-section vertical-section-container centered">
    <dom-module id="demo-element">
      <template>
        <iron-localstorage name="polymer-localstorage-x-test1" value="{{value}}" on-iron-localstorage-load-empty="initializeDefaultValue">
        </iron-localstorage>
      ...
      <script type="module">import "../../paper-styles/demo-pages.js";
