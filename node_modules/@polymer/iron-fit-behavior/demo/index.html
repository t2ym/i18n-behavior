...
document.body.appendChild(template.content);</script>
  ...
  <script type="module">import { dom } from "../../polymer/lib/legacy/polymer.dom.js";
...
var observerHandle = demoSnippetDOM.observeNodes(function () {
  ...
  templatev1.toggleDynamicAlign = template.toggleDynamicAlign; // Listen for resize and scroll on window.
